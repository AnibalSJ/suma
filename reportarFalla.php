<?php 
    ...
    $sql = "SELECT * FROM usuario WHERE id = $cliente";
...
<body>
        ...
        <div class="main-principal-portal" id="main-co">
            <div class="con-sp-n">
                <div class="header-p">
                    <div class="info-u">
                        <?php
                            while($row = $datosCliente->fetch_assoc()){
                                ?>
                            ...
                            <div class="soportepn">
                                <div class="items-info items-sopor">
                                    <div class="cabecera">
                                        <h5 onclick="itemInfoSoporte('con-sopo-info')">
                                            ...
                                            INFORMACIÓN</h5>
                                        <img src="./assets/img/img-audios/etbA.svg" alt="parlante-audio-etb" class="img-audio" id="img_info_sf" onclick="alertAudio('au_info_sf', 'img_info_sf', 5, 1)">
                                ...
                                <div class="items-info items-sopor">
                                    <div class="cabecera">
                                        ...
                                        <img src="./assets/img/img-audios/etbA.svg" alt="parlante-audio-etb" class="img-audio" id="img_infra_sf" onclick="alertAudio('au_infra_sf', 'img_infra_sf', 5, 2)">
                                    ...
                                    <div class="body-items-inf item-larg">
                                        <div class="contet con-tree-colms" id="con-sopo-prueba-ra">
                                            ...
                                            <div class="items-actions-soporte">
                                                ...
                                                <img src="./assets/img/img-audios/etbA.svg" alt="parlante-audio-etb" class="img-audio" id="img_act_in_sf" onclick="alertAudio('au_act_in_sf', 'img_act_in_sf', 5, 5)">
                                ...
                                <div class="items-info items-sopor">
                                    <div class="cabecera">
                                        <h5 onclick="itemInfoSoporte('con-sopo-inter')">
                                            <img src="./assets/img/rule.svg" alt="" class="menus-cabecera">
                                            INTERNET</h5>
                                            <img src="./assets/img/img-audios/etbA.svg" alt="parlante-audio-etb" class="img-audio" id="img_it_sf" onclick="alertAudio('au_it_sf', 'img_it_sf', 5, 11)">
                                            <audio id="au_it_sf" controls class="audio" style="display: none;">
                                                <source type="audio/wav" src="./assets/audio/aseg/au_it_sf.wav">
                                            </audio>
                                    </div>
                                    <div class="body-items-inf">
                                        <div class="contet hide-body con-tree-colms" id="con-sopo-inter">
                                            ...
                                            <div class="items-actions-soporte items__actions_four">
                                                ...
                                                <img src="./assets/img/img-audios/etbA.svg" alt="parlante-audio-etb" class="img-audio" id="img_act_it_sf" onclick="alertAudio('au_act_it_sf', 'img_act_it_sf', 5, 13)">
                                                <audio id="au_act_it_sf" controls class="audio" style="display: none;">
                                                    <source type="audio/wav" src="./assets/audio/aseg/au_act_it_sf.wav">
                                                </audio>
                                                ...
                                                <img src="./assets/img/img-audios/etbA.svg" alt="parlante-audio-etb" class="img-audio" id="img_consultas_it_sf" onclick="alertAudio('au_consultas_it_sf', 'img_consultas_it_sf', 5, 12)">
                                                <audio id="au_consultas_it_sf" controls class="audio" style="display: none;">
                                                    <source type="audio/wav" src="./assets/audio/aseg/au_consultas_it_sf.wav">
                                                </audio>
                                ...
                                <div class="items-info items-sopor">
                                    <div class="cabecera">
                                        <h5 onclick="itemInfoSoporte('con-sopo-ajustes-wifi')">
                                            <img src="./assets/img/rule.svg" alt="" class="menus-cabecera">
                                            Ajustes WIFI (ONT)</h5>
                                        <img src="./assets/img/img-audios/etbA.svg" alt="parlante-audio-etb" class="img-audio" id="img_aw_sf" onclick="alertAudio('au_aw_sf', 'img_aw_sf', 5, 14)">
                                        <audio id="au_aw_sf" controls class="audio" style="display: none;">
                                            <source type="audio/wav" src="./assets/audio/aseg/au_aw_sf.wav">
                                        </audio>
                                    </div>
                                    <div class="body-items-inf">
                                        <div class="contet hide-body con-tree-colms" id="con-sopo-ajustes-wifi">
                                            ...
                                            <div class="items-actions-soporte items__actions_four" style="border-top: 0px;">
                                                ...
                                                <img src="./assets/img/img-audios/etbA.svg" alt="parlante-audio-etb" class="img-audio" id="img_act_aw_sf" onclick="alertAudio('au_act_aw_sf', 'img_act_aw_sf', 5, 16)">
                                                <audio id="au_act_aw_sf" controls class="audio" style="display: none;">
                                                    <source type="audio/wav" src="./assets/audio/aseg/au_act_aw_sf.wav">
                                                </audio>
                                                ...
                                                <img src="./assets/img/img-audios/etbA.svg" alt="parlante-audio-etb" class="img-audio" id="img_consultas_aw_sf" onclick="alertAudio('au_consultas_aw_sf', 'img_consultas_aw_sf', 5, 15)">
                                                <audio id="au_consultas_aw_sf" controls class="audio" style="display: none;">
                                                    <source type="audio/wav" src="./assets/audio/aseg/au_consultas_aw_sf.wav">
                                                </audio>
                                ...
                                <div class="items-info items-sopor">
                                    <div class="cabecera">
                                        <h5 onclick="itemInfoSoporte('con-sopo-telefo')">
                                            <img src="./assets/img/rule.svg" alt="" class="menus-cabecera">
                                            LINEA TELEFONICA</h5>
                                        <img src="./assets/img/img-audios/etbA.svg" alt="parlante-audio-etb" class="img-audio" id="img_lineaT_sf" onclick="alertAudio('au_lineaT_sf', 'img_lineaT_sf', 5, 6)">
                                    ...
                                    <div class="body-items-inf">
                                        <div class="contet hide-body con-tree-colms" id="con-sopo-telefo">
                                            ...
                                            <div class="items-actions-soporte items__actions_four">
                                                ...
                                                <img src="./assets/img/img-audios/etbA.svg" alt="parlante-audio-etb" class="img-audio" id="img_act_lt_sf" onclick="alertAudio('au_act_lt_sf', 'img_act_lt_sf', 5, 8)">
                                                ...
                                                <img src="./assets/img/img-audios/etbA.svg" alt="parlante-audio-etb" class="img-audio" id="img_consultas_lt_sf" onclick="alertAudio('au_consultas_lt_sf', 'img_consultas_lt_sf', 5, 7)">
                                ...
                                <div class="items-info items-sopor">
                                    <div class="cabecera">
                                        <h5 onclick="itemInfoSoporte('con-sopo-tv')">
                                            <img src="./assets/img/rule.svg" alt="" class="menus-cabecera">
                                            TELEVISIÓN</h5>
                                        <img src="./assets/img/img-audios/etbA.svg" alt="parlante-audio-etb" class="img-audio" id="img_tv_sf" onclick="alertAudio('au_tv_sf', 'img_tv_sf', 5, 9)">
                                    ...
                                    <div class="body-items-inf">
                                        <div class="contet hide-body con-tree-colms" id="con-sopo-tv">
                                            ...
                                            <div class="items-actions-soporte seven__actions">
                                                ...
                                                <img src="./assets/img/img-audios/etbA.svg" alt="parlante-audio-etb" class="img-audio" id="img_act_sf" onclick="alertAudio('Au_act_sf', 'img_act_sf', 5, 10)">
                                        ...
                                        <div class="contet " id="con-logs-sp">
                                            <div class="con-table">
                                                <table class="table-general table-sopor table-sopor-logs">
                                                    ...
                                                    <tr>
                                                        <td>15/05/2023 12:25:37 PM</td>
                                                        <td>15/05/2023 12:25:44 PM</td>
                                                        <td>H TV PLAN</td>
                                                        <td>Plan</td>
                                                        <td>Estado Plataforma</td>
                                                        <td>response:OK,value:SILVER </td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
    ...
    <div class="alert-flotante" id="alert-flotante">
        <div class="etb-flotant" id="etb-flotant">
            <img src="./assets/img/ETB.svg" alt="">
        </div>
        <div class="mensaje-parlante" id="mensaje-parlante">
            <p id="text-msg-hab">
